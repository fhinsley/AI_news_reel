#!/usr/bin/env python3
"""Generate a formatted PDF transcript from stories.json.
...
Pipeline position: run after script_generator.py, independently of TTS/video steps.
Output: <EPISODE_DIR>/Transcript.pdf
...
INPUT_FILE  = config.STORIES_JSON
OUTPUT_FILE = config.EPISODE_DIR / "Transcript.pdf"
